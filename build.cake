...
Task("Package")
    ...
    {
        var package =
            outputPackages + File("Nancy.Bootstrappers.Autofac-Latest.zip");
    ...
    .Does(() =>
    {
        ...
        else
        {
            ...
            var settings = new ProcessSettings {
                Arguments = xunit + " " + "test/Nancy.Bootstrappers.Autofac.Tests/bin/"+configuration+"/net452/unix-x64/Nancy.Bootstrappers.Autofac.Tests.dll"
            };
            ...
            using(var process = StartAndReturnProcess("mono", settings))
            {
                ...
                {
                    throw new Exception("Nancy.Bootstrappers.Autofac.Tests failed.");
                }
            }
        }
    });
...
Task("Update-Version")
    ...
    .Does(() =>
    {
        ...
        UpdateProjectJsonVersion(version, "src/Nancy.Bootstrappers.Autofac/project.json");
    });
